...
export const defaultBlueTraits: TraitId[] = ["clone_spawn", "clone_bomb", "auto_turret", "hp_boost"];
export const defaultRedTraits: TraitId[] = ["death_split", "giant_body", "collision_boost", "wall_charge"];
